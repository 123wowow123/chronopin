...
// pin form (the Angular app kept two copies in sync by hand). Each name is one
// word, as granular as the corpus needs: a pin carries as many as it is about,
// so "Conferences & Festivals" is Conference and Festival, and an anime film is
// Anime and Movie. Add a new word here rather than filing a pin under a broad
// one.
...
// URL slug for a category or company name: "Space" -> "space", "Rolls-Royce"
// -> "rolls-royce".
