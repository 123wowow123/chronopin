...
type Card = Pick<PinJson, 'id' | 'user' | 'userId'>;

// Whether the reader's timeline and search leave a pin's card out: its author
// is someone they blocked (0076), or they marked it "Not interested" (0077) on
// an earlier page. One marked on this page stays, folded to a line with Undo
