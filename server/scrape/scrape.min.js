...
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }(); // What the page's own markup can give that reading its text cannot: images
...
(function combine() {
  ...
  window.cpScrapePromise = new Promise(function (resolve, reject) {
    ...
    Promise.all([imageRes, youtubeRes, twitterRes]).then(function (_ref) {
...
},{"./image":5,"./twitter":6,"./youtube":7}],2:[function(require,module,exports){
'use strict';
...
},{"../util":4,"jquery":8}],3:[function(require,module,exports){
'use strict';
...
},{"../util":4,"jquery":8}],4:[function(require,module,exports){
'use strict';
...
function getImageSizes(images) {
  ...
  var imagePromises = images.map(function (imageUrl) {
    ...
    return Promise.race([(0, _util.wait)(timeout).catch(function () {
...
},{"../helper/meta_tag":2,"../helper/selector_attribute":3,"../helper/util":4}],6:[function(require,module,exports){
'use strict';
...
},{"../helper/util":4}],7:[function(require,module,exports){
"use strict";
...
},{"../helper/util":4}],8:[function(require,module,exports){
/*!
