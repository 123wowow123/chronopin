  ...
  let sql = `
        ...
        AS
          BEGIN
            ...
            EXEC [dbo].[GetPinsWithFavoriteAndLikePrevFilterByHasFavorite] 0, @pageSizePrev, @userId, @fromDateTime, 0, @createdSinceDateTime = @createdSinceDateTime, @queryCount = @queryCountPrev OUTPUT;

            INSERT INTO @tempPinsTbl
            EXEC [dbo].[GetPinsWithFavoriteAndLikeNextFilterByHasFavorite] 0, @pageSizeNext, @userId, @fromDateTime, 0, @createdSinceDateTime = @createdSinceDateTime, @queryCount = @queryCountNext OUTPUT;
