  ...
  let sql = `
        ...
        AS
          BEGIN
            ...
            EXEC [dbo].[GetPinsWithFavoriteAndLikePrev] 0, @pageSizePrev, @userId, @fromDateTime, 2147483647, @followingOnly, @queryCount = @queryCountPrev OUTPUT;

            INSERT INTO @tempPinsTbl
            EXEC [dbo].[GetPinsWithFavoriteAndLikeNext] 0, @pageSizeNext, @userId, @fromDateTime, 0, @followingOnly, @queryCount = @queryCountNext OUTPUT;
