-- Why each reference got its confidence: what the page itself says about the
-- event and its date, the way dateConfidenceReasoning explains the source's
-- rating. Shown under the reference in the pin page's References panel.

ALTER TABLE "PinReference" ADD COLUMN "reasoning" varchar(2000);

-- The reasoning goes into the references json; the rest is 0010's view.
