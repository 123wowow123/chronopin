        ...
        .component('pinBlock', {
            ...
            <div class="grid__media" ng-switch="$ctrl.pin.media[0].type">
                ...
                <div ng-switch-when="1">
                    <a class="grid__asset grid__asset--link" ng-if="$ctrl.pin.media[0].thumbName"
                        ui-sref="pin({id:$ctrl.pin.id})">
                        <img ng-src="{{$ctrl.config.thumbUrlPrefix + $ctrl.pin.media[0].thumbName}}" class="grid__image"
                            ng-style="{'height': ($ctrl.pin.media[0].thumbHeight * 0.757188498) + 'px' }" />
                    </a>
                </div>
            ...
            <div class="grid__body">
                ...
                <div class="grid__footer">
                    <div class="grid__price" ng-class="{'grid__price--negative': $ctrl.pin.price < 0}" ng-if="$ctrl.pin.price">
                        {{$ctrl.pin.price | money}}</div>
