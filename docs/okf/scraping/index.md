...
* [Scraping strategy](strategy.md) - The stages from a URL to a saved pin, the decision rules at each, and the quality bar; the basis for the Scraping API
* [Extraction fields](fields.md) - The one extraction call: every field, its rule, and where the exact prompt and schema live
* [Enrichment stages](enrichment.md) - References, pictures, screen extras, studio HQ, awards and tags, threads, release-notes entries
